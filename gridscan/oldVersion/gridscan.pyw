...
class DACcorr(QMainWindow):
    ...
    def initUI(self):              
        ...
        self.setWindowTitle('PX2 Grid Scan')   
    ...
    def updateUI(self):
        ...
        if X_srt <= XD or X_end <= XD:
            ...
            epics.caput('13MARCCD3:cam1:AutoIncrement',0)
            ...
            for M_X in range(X_Ntp):
                for N_Y in range(Y_Ntp):
                    ...
                    epics.caput('13MARCCD3:cam1:FileName',tmp)
                    time.sleep(5)
                    epics.caput('13MARCCD3:cam1:AcquireTime',exp_tim)
                    epics.caput('13MARCCD3:cam1:Acquire',1)
                    time.sleep(exp_tim+5)                
            epics.caput('13MARCCD3:cam1:AutoIncrement',1)
